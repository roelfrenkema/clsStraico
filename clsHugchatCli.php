...
class clsHugchatCli extends Straico
{
	...
	*/
    ...
    public function userPrompt($input)
    {
        ...
        if ($input == '/exit') {
            ...
            parent::hugListModels(substr($input, 12));
            $answer = "INFO: End of list\n";

            // Load available huggingface models
        } elseif ($input == '/hugmodels') {
            parent::hugModels(substr($input, 12));
            $answer = "INFO: Models loaded. View with /listmodels.\n";
         ...
         */
            ...
            $answer = parent::hugCompletion(trim(substr($input, 11)));
         ...
         */
            ...
            $answer = parent::hugCompletion($input);
         ...
         */
            ...
            $answer = parent::hugCompletion($input, 5);
